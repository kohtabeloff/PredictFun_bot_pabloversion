...
6. **Отменить все ордера** — убирает все ордера из стакана; стратегии продолжают работать и выставят ордера заново
...
| Мин. ордеров перед | Минимальное количество чужих ордеров в стакане перед позицией бота |
